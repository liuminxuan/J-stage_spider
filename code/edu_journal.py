'''
  function:爬取j-stage（教育学研究ジャーナル）杂志论文，并写入Excel文件
  env:python3.6.5
  author:lmx
'''
import time
...
class Jstage:
    def __init__(self):
        #起始地址
        self.start_url = 'https://www.jstage.jst.go.jp/browse/csssej/' # url前半部分不变，只需修改最后数字
        #请求头，浏览器模拟
        self.headers = {
...
if __name__ == '__main__':
    ...
    top = Jstage()
    try:
        top.saveToExcel('edu_journal.xlsx')
